...
unless (%config = do "$dir/graph_config.pl") {
            warn "couldn't parse $dir/graph_config.pl: $@" if $@;
            warn "couldn't do $dir/graph_config.pl: $!"    unless %config;
            warn "couldn't run $dir/graph_config.pl"       unless %config;
}
